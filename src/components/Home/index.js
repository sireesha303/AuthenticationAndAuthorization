    ...
    <>
        ...
        <div className='home-container'>
            <div className='home-details-container'>
                ...
                <p className='home-description'>Fashion is part of the daily air and it does not quite help that it changes all the time. 
            ...
            <img src="https://assets.ccbp.in/frontend/react-js/nxt-trendz-home-img.png" 
            alt="dresses to be noticed" className='home-desktop-img'/>
        </div>
